...
(function ($) {
  ...
  */
        ...
        // Isotope Define
        var $container = $('.portolio-container');
  ...
  */
        ...
        // Youtube loading
        $("#loader .la-anim-1").delay("100").addClass('la-animate');
  ...
  */
  ...
  /*
  Hexagon hover for social links
  */

        $(".hexagon-mask")
            .mouseenter(function () {
                $(".fa").removeClass("fadeOutUp");
                $(".fa").addClass("fadeInDown");
            })
            .mouseleave(function () {
                $(".fa").removeClass("fadeInDown");
                $(".fa").addClass("fadeOutUp");
            });
  ...
  */
		...
		setTimeout(function(){
			$("#iframe_gmaps").attr('src', 'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3102.7614321917945!2d-68.056133!3d-38.952278199999995!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x960a33d1705fe0db%3A0x92466ba0e901d1bd!2sSanta+Fe+269%2C+Neuqu%C3%A9n!5e0!3m2!1ses!2sar!4v1406935356168');
		}, 2000);
		
        $(".gmap-overlay")
            .click(function () {
                $(".gmap-overlay").fadeOut("fast").hide(0);
                $(".gmap").addClass('selected')
            })

        $(".gmap")
            .mouseleave(function () {
                $(".gmap-overlay").fadeIn("fast").show(0);
                $(".gmap").removeClass('selected')
            });
  ...
  */
        ...
        $(".header .ancla, .item a").click(function (event) {
...
$my_form.validate(function($form, e){
	...
	$.ajax({
           type: "POST",
           url: "http://www.dityc.com/pagina/sendEmail",
           contentType: "application/x-www-form-urlencoded",
           processData: true,
           data: dataString,
 		   beforeSend: function(){
				$('#btn-enviar').html('<i class="fa fa-spinner fa-spin"></i> Enviar Mensaje').attr("disabled", "disabled");;
 		   },
           success: function(data){
                 $("#mensaje").show();
                 setTimeout(function() {$('#mensaje').fadeOut('slow');}, 3800);
                 $('#nombre').val('');
                 $('#email').val('');
                 $('#url').val('');
                 $('#consulta').val('');
                 $('#btn-enviar').html('Enviar Mensaje').removeAttr("disabled");
           }
         });	
        e.preventDefault();
})
