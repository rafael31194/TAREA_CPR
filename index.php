...
<head>
  ...
  <link rel="shortcut icon" href="http://localhost/TAREA_CPR/favicon_1.ico">
  <link rel="stylesheet" href="http://localhost/TAREA_CPR/theme/css/font-awesome.css">
  <!-- Twitter -->
  ...
  <!-- Facebook -->
  <meta property="og:url" content="http://localhost/TAREA_CPR/">
  ...
  <link rel="stylesheet" href="http://localhost/TAREA_CPR/theme/css/all.min.css">

  <!-- Google Fonts -->
  <link href='http://fonts.googleapis.com/css?family=PT+Sans:400,700&amp;subset=latin,latin-ext' rel='stylesheet' type='text/css'>

  <!-- Jquery -->
  <script type="text/javascript" src="http://localhost/TAREA_CPR/theme/js/jquery-2.1.0.min.js"></script>
...
<body>
  ...
  <!-- SERVICIOS -->
  <section class="section services" id="servicios" style="background: url(http://localhost/TAREA_CPR/uploads/img/services-bg.jpg);" data-stellar-background-ratio="1.5">
    <?php
  ...
  <script src="http://localhost/TAREA_CPR/theme/front/js/validate.es_AR.js" type="text/javascript"></script>
  <script src="http://localhost/TAREA_CPR/theme/front/js/frontend.es_AR.js" type="text/javascript"></script>
  <script type="text/javascript" src="http://localhost/TAREA_CPR/theme/js/all.min.js"></script>
</body>
</html>
